...
The `vmeasure_calc()` function internally calculates intersections of the input geometries using `sf::st_intersection()`, which depends on the coordinates values precision. 
